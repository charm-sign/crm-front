    ...
    <el-card>
      <el-form :inline="true" class="demo-form-inline">
        ...
        <el-form-item label="状态">
          <el-select v-model="customerQuery.status" placeholder="潜在客户">
            <!-- 查询出来的 -->

            <el-option
              v-for="statu in statusList"
              :label="statu.title"
              :value="statu.sequence"
              :key="statu.id"
            ></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button
            ...
            >查询</el-button
          >
          <el-button type="primary" @click="resetData()">添加</el-button>
        </el-form-item>
      </el-form>
      <el-table
        ref="multipleTable"
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" width="180" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="getInfo2(scope.row.id)"
              >跟进</el-button
            >
